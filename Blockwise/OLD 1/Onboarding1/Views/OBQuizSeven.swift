...
struct OBQuizSeven: View {
    ...
    let options: [OBOption] = [
        ...
        OBOption(emoji: "", label: "No", value: 2),
    ]
    
    let questionNumber: Int = 7
    let question: String = "Do you check your phone as soon as you wake up?"
...
//        }
    ...
    private func action(option: OBOption) {
        ...
        SleepTask.sleep(seconds: vm.actionDelay) {
            vm.nextStep()
            vm.mixPanelTrack(name: "Quiz 7", properties: [question : selectedOption.label])
        }
    }
}
