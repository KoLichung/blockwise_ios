...
struct OBReportTwoView: View {
    ...
    var body: some View {
        VStack(spacing: 48) {
            Text("This year alone, you're going to spend:")
            ...
            VStack(spacing: 20) {
                ...
                Group {
                    ...
                    Text(" 121 days").bold().foregroundStyle(.red.gradient) +
                    Text(".")
                }
                .font(.system(size: 24).weight(.semibold))
                .offset(y: appearAnimation ? 0 : 32)
