...
struct OBNineView: View {
    @EnvironmentObject var vm: OBUserViewModel
    
    @State private var selectedOption: OBOption?

    let question = "Do you often experience brain fog?"
    let subtitle = "Question #9"
    ...
    let descriptions: [String] = [
        ...
        "Some days I’m focused, other days I’m foggy.",
        "I always struggle to think clearly"
    ]
