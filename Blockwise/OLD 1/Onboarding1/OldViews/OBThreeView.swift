...
struct OBThreeView: View {
    @EnvironmentObject var vm: OBUserViewModel
    
    @State private var selectedOption: OBOption?

    let question = "Are you satisfied with your usage?"
    let subtitle = "Question #3"

    let options: [OBOption] = [
        OBOption(emoji: "nerd-face", label: "Very satisfied", value: 5),
        OBOption(emoji: "slightly-frowning", label: "Meh", value: 4),
        OBOption(emoji: "sad", label: "Not at all", value: 3)
    ]
    
    let descriptions: [String] = [
        "Everything is under control",
        "Okay, but could be better",
        "I lose too much time to distractions"
    ]
