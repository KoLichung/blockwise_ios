...
struct OB6_V2: View {
    ...
    let question: String = "What is your daily average screen time?"
    let subheadline: String = "Your best guess is ok"

    let answers: [OBAnswer] = [
        OBAnswer(title: "1-2 hours", points: 2),
        OBAnswer(title: "2-4 hours", points: 3),
        OBAnswer(title: "4-6 hours", points: 5),
        OBAnswer(title: "6-8 hours", points: 7),
        OBAnswer(title: "Over 8 hours", points: 9),
    ]
...
//        .scrollDisabled(!allowMultipleAnswers)
    ...
    private func action(answer: OBAnswer) {
        ...
        SleepTask.sleep(seconds: vm.nextPageDelay) {
            vm.nextPage(progress: 0.7)
        }
        
        // Specific to view
        vm.estimatedScreenTime = answer.points
        
        // Mixpanel
        AnalyticsService.shared.track("OBV2 > Avg. Screen Time")
    }
