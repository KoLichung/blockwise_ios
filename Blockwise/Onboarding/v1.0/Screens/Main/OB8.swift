...
struct OB8: View {
    ...
    let answers: [OBAnswer] = [
        ...
        OBAnswer(title: "18-23", points: 22),
        OBAnswer(title: "24-29", points: 28),
        OBAnswer(title: "30-39", points: 36),
        OBAnswer(title: "40-49", points: 46),
        OBAnswer(title: "Above 50", points: 55),
    ]
